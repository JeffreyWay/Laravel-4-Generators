...
class ModelGeneratorCommand extends BaseGeneratorCommand {
	 ...
	 * @var string
	 */
	protected $description = 'Generate a new models with relations.';
	...
	{
		return array(
			array('name', InputArgument::REQUIRED, 'Name of the models to generate.'),
		);
	}
	...
	protected function getOptions()
	{
		return array(
			...
			array('template', null, InputOption::VALUE_OPTIONAL, 'Path to template.', __DIR__.'/../Generators/templates/models.txt')
		);
	}
